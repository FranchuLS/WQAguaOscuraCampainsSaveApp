...
class LevelsDiscardedScreen extends StatelessWidget {
  ...
  const LevelsDiscardedScreen({super.key, required this.campaign});
  ...
  Widget build(BuildContext context) {
    ...
    final levels = repository.getDiscardedLevelsByCampaign(campaign.id);

    return Scaffold(
      appBar: AppBar(
        title: const Text('Niveles descartados'),
        centerTitle: true,
